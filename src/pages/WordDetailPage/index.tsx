            ...
            <Label title={speechObj[words]}/>
            {
              Object.keys(wordObj[words]).map(property => {
                if(property !== 'simple' && property !== 'tags') {
                  layoutLength++
                  return(
                    <Text key={`${words}${propertyObj[property]}`} style={styles.propertyText} onPress={() => {
            ...
            return (
              ...
              >
                {(property !== 'simple' && property !== 'tags') && 
                  <Accordion title={propertyObj[property]} content={accordionBody} key={`accordion${propertyIndex}`} onOpen={() => {

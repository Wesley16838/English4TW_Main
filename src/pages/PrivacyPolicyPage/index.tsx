      ...
      <SafeAreaView>
        ...
        >
          ...
          >
            ...
            <Text style={styles.listTitle}>一、隱私權保護政策的適用範圍</Text>
            <Text style={{ marginBottom: 25 }}>
            ...
            <Text>
              當您洽辦本網站業務或參與本網站活動時，我們將視業務或活動性質請您提供必要的個人資料，並在該特定目的範圍內處理及利用您的個人資料;
            ...
            <Text style={styles.listTitle}>三、資料之保護</Text>
            <Text>
            ...
            <Text style={styles.listTitle}>四、網站對外的相關連結</Text>
            <Text style={styles.listContent}>
              本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。
            </Text>
            <Text style={styles.listTitle}>五、與第三人共用個人資料之政策</Text>
            <Text style={styles.listContent}>
            ...
            <View style={styles.row}>
              <Text>&#8226; </Text>
              <Text style={styles.rowContent}>
                與公務機關或學術研究機構合作，基於公共利益為統計或學術研究而有必要，且資料經過提供者處理或搜集著依其揭露方式無從識別特定之當事人。
              </Text>
            </View>
            <View style={styles.row}>
              <Text>&#8226; </Text>
            ...
            <View style={{ ...styles.row, marginBottom: 25 }}>
              <Text>&#8226; </Text>
              <Text style={styles.rowContent}>
                本網站委託廠商協助蒐集、處理或利用您的個人資料，將對委外廠商或個人善盡監督管理之責。
              </Text>
            </View>
            <Text style={styles.listTitle}>六、Cookie之使用</Text>
            <Text style={styles.listContent}>
              為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的Cookie，若您不願接受Cookie的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕Cookie的寫入，但可能會導致網站某些功能無法正常執行。
            </Text>
            <Text style={styles.listTitle}>七、個人資料之使用</Text>
            <View style={styles.row}>
              <Text>&#8226; </Text>
              <Text style={styles.rowContent}>
                English4TW僅保留註冊時輸入的姓名與電子郵件以提供帳號註冊/登入使用。
              </Text>
            </View>
            <View style={styles.row}>
              <Text>&#8226; </Text>
              <Text style={styles.rowContent}>
                如您使用Facebook登入功能，透過Facebook取得之姓名與電子郵件僅供帳號註冊/登入目的使用。
              </Text>
            </View>
            <View style={styles.row}>
              <Text>&#8226; </Text>
              <Text style={styles.rowContent}>
                網站並無搜集或使用其他個人資料或網站使用紀錄/足跡。
              </Text>
            </View>
            <View style={styles.row}>
              <Text>&#8226; </Text>
              <Text style={{ ...styles.listContent, flex: 1 }}>
                您的帳號與資料可透過帳號個人資料頁面進行刪除。
              </Text>
            </View>
            <Text style={styles.listTitle}>八、隱私權保護政策之修正</Text>
            <Text style={styles.rowContent}>

      ...
      <SafeAreaView>
        ...
        >
          ...
          >
            ...
            <Text style={Typography.pageTitle as TextStyle}>進階功能</Text>
          ...
          >
            <Text style={Typography.base_bold}>目前方案: {"30天方案"}</Text>
            <Text style={Typography.base_bold}>到期日: {"2020-12-20"}</Text>
          </View>
